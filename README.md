...
This repository contains sources for the kernels in [hf.co/kernels-test](https://huggingface.co/kernels-test)
that are used for testing.

PRs from outside Hugging Face are not accepted in this repository.
